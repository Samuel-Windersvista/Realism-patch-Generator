...
- 提供 rule_range_editor.py 图形化规则范围编辑器，可直接修改规则并一键生成补丁。
...
1. 左侧选择规则类别和档位
2. 右侧双击最小值或最大值修改范围
3. 观察下方字段说明面板，确认字段语义和方向
4. 点击“保存全部”，自动备份当前被修改的规则文件
5. 点击“生成补丁”，直接执行 generate_realism_patch.py
