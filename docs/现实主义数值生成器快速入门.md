...
如果你只想调规则，不想手改 Python 文件，也可以先打开 GUI 编辑器：

- Windows：双击 规则范围编辑器.bat
- 命令行：.\.venv\Scripts\python.exe rule_range_editor.py
...
如果你不想直接改文件，优先使用 GUI 编辑器去改这些规则范围。
