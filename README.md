...
**EFT 现实主义数值生成器 v3.12** 是一个功能强大的Python脚本，用于为《逃离塔科夫》(Escape from Tarkov)的 SPT3.11.4 现实主义 MOD (Realism Mod) 自动重建并生成数值配置。它可以根据 `input/` 文件夹中的物品数据，使用预定义模板快速生成规范化配置文件。
...
| 版本 | 日期 | 主要更新 |
|------|------|---------|
| **v3.12** | 2026-03-12 | 🎛️ **枪托视觉/镜头后坐细分与口径补全** - 第三层枪托修正为所有类别补充 `CameraRecoil` 与 `VisualMulti` 差异，并新增武器 `5.8x42` 独立分组，完善 `9x39` 与 `Caliber58x42` 武器识别链路。 |
