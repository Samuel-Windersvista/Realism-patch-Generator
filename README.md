...
**EFT 现实主义MOD兼容补丁生成器 v2.8** 是一个功能强大的Python脚本，用于为《逃离塔科夫》(Escape from Tarkov)的SPT3.11.4的现实主义MOD (Realism Mod) 自动生成兼容补丁。它可以根据 `input/` 文件夹中的物品数据，使用预定义的模板快速生成规范化的配置文件。
